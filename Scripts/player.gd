...
#SPEED VARIABLES
var base_speed = 8.0 #Base player speed
var speed = base_speed #Current speed (Default to base_speed)
var sprint_speed = 14.0 #Sprint player speed
var shift_speed = 4.0 #Shift player speed
var crouch_speed = 2.0 #Crouch player speed
